...
public abstract class Children extends Object {
    ...
    */
    ...
    private static final org.openide.ErrorManager LOG_GET_ARRAY = 
        org.openide.ErrorManager.getDefault ().getInstance ("org.openide.nodes.Children.getArray"); // NOI18N
    ...
    private ChildrenArray getArray (boolean[] cannotWorkBetter) {
        ...
        if (doInitialize) {
            ...
            try {
                ...
                if (IS_LOG_GET_ARRAY) {
                    LOG_GET_ARRAY.log ("notifyAll for " + this + " on " + Thread.currentThread ()); // NOI18N
                }
                boolean notifyLater;
                synchronized (LOCK) {
