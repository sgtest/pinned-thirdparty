    ...
    public static class Reflection extends Node.Property {
        ...
        */
        ...
        private static Method findGetter( Object instance, Class valueType, String property ) throws NoSuchMethodException {
            ...
            try { 
                return findAccessibleClass (instance.getClass ()).getMethod ( firstLetterToUpperCase (property, "get"), new Class[0] );
            }   
            ...
            try {
                return findAccessibleClass (instance.getClass ()).getMethod ( firstLetterToUpperCase (property, "is"), new Class[0] );
            }
            catch ( NoSuchMethodException e ) {
                throw e;
            }
