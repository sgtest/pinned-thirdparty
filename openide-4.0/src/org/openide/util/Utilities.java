...
//        }
    ...
    public static javax.swing.JPopupMenu actionsToPopup (
        ...
        javax.swing.JPopupMenu menu = null;// org.netbeans.modules.openide.util.AWTBridge.getDefault ().createEmptyPopup ();
        ...
        for (int i = 0; i < actions.length; i++) {
            ...
            if (action != null) {
                ...
                if (action instanceof org.openide.util.actions.Presenter.Popup) {
                    ...
                    JMenuItem mi = null;//org.netbeans.modules.openide.util.AWTBridge.getDefault ().createPopupPresenter (action);
                    menu.add(mi);
                }
            }
