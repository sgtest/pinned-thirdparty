...
public abstract class CallableSystemAction extends SystemAction
    ...
    */
    ...
    //private static Map runningActions = new HashMap(4); // Map<Runnable,CallableSystemAction>
    
    /**
     * Invoke this action either in the event thread or in the request processor.
